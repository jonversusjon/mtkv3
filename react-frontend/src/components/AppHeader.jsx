...
function AppHeader({ darkMode, toggleDarkMode }) {
  ...
  return (
    <header className="fixed top-0 left-0 z-10 box-border flex justify-between items-center w-full h-24 px-6 shadow-sm text-white bg-gradient-to-r from-indigo-900 from-10% via-gray-950 via-50% to-blue-900 to-90%">
